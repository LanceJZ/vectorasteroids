...
int main(int argc, char **argv)
{
	...
	Player *pThePlayer;
	UFOController *pTheUFOController;
	RockController *pTheRockController;
	...
	pTheRockController = new RockController(*pThePlayer);
	//pTheRockController = new RockController();
	...
	//pTheRockController->SetReferences(*pThePlayer, *pTheUFOController);
	//pTheUFOController->SetReferences(*pThePlayer, *pTheRockController);
